<?php
	...
	if(isset($_GET['artist']))
	{
		...
		echo "<tr>";
			echo "<td><a href='../home.php'>home</a>-><a href='./hollywood.php'>English Song</a>->".$artist."</td>";
		echo "</tr>";
		echo "</table>";
		...
		echo "<h2>".$artist."</h2>";
		$query="select song from english where artist='$artist'";
